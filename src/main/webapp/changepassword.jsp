...
<%
    ...
    // Get the logged-in user's ID from the session (ensure this is set during login)
    ...
    if (request.getMethod().equalsIgnoreCase("POST")) {
        ...
        if (newPassword.equals(confirmPassword)) {
            ...
            try {
                // Database connection
                Class.forName("com.mysql.cj.jdbc.Driver"); // Change to your DB driver
    ...
    <div class="container">
        ...
        <% if (successMessage != null) { %>
            ...
            <script>
                ...
                setTimeout(function() {
                    window.location.href = 'graphuser.jsp';
                }, 2000); // 2-second delay
            </script>
        <% } %>
