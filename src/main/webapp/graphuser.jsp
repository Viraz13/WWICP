...
<div class="container">
    ...
    <div class="chart-box">
     <div class="total-cases">
      <a href="viewusers.jsp" >Total Cases: <%= totalCases %></a>
    </div>
        ...
        options: {
            ...
            onClick: function(event, elements) {
                if (elements.length > 0) {
                    ...
                    if (label === 'Open Cases') {
                        window.location.href = 'opencust.jsp';
                    } else if (label === 'Resolved Cases') {
                        window.location.href = 'resolvedcust.jsp';
                    } else if (label === 'Waiting on Vendor') {
                        window.location.href = 'wovcust.jsp';
                    } else if (label === 'Working in Process') {
                        window.location.href = 'wopcust.jsp';
                    }
                }
            }
        }
