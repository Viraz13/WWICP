...
<section>
    ...
    <div class="container">
       ...
       if (loggedInUser == null || role == null) {
           ...
           List<User> wvcases = UserDao.getworkingvendorCases(loggedInUser, role);
    request.setAttribute("wvcases", wvcases);
}%>
        
            <div class="text-end mb-3">
        <a href="wovexcel.jsp" class="btn btn-danger btn-sm">
