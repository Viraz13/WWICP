...
<jsp:include page="hdr2.html"></jsp:include>
...
<section>
    ...
    <div class="container">
       ...
       if (loggedInUser == null || role == null) {
           ...
           List<User> wpcases = UserDao.getworkingprogessCases(loggedInUser, role);
    request.setAttribute("wpcases", wpcases);
}%>
        
            <div class="text-end mb-3">
      <a href="wopexcel.jsp" class="btn btn-danger btn-sm">
